...
#include "../include/solo12_controller/solo12_controller.hpp"
...
PLUGINLIB_EXPORT_CLASS(
  solo12_controller::RobotController, controller_interface::ControllerInterface)
